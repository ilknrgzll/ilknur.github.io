    ...
    <>
      ...
      >
        ...
        <Link to="home" smooth={true} duration={500} className="flex items-center gap-4 cursor-pointer lg:hover:opacity-50 p-2 transition-all">
          <img src="/me.jpg" alt="İlknur's Avatar" className="w-14 h-14 rounded-full object-cover" />
          <div className="flex flex-col">
            <span className="font-bold text-lg">İlknur</span>
            <span className="text-white-darkest text-sm">Full Stack Dev </span>
          </div>
        </Link>
